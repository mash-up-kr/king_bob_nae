...
import com.example.king_bob_nae.features.mykkilog.presentation.result.data.deletekkilog.DeleteKkilogResult
...
import com.example.king_bob_nae.features.mykkilog.presentation.result.data.postkkiloglike.PostKkilogLikeResult
import com.example.king_bob_nae.features.mykkilog.presentation.result.data.postkkilogscrap.PostKkilogScrapResult
import com.example.king_bob_nae.features.mykkilog.presentation.result.data.postkkilogunlike.PostKkilogUnLikeResult
import com.example.king_bob_nae.features.mykkilog.presentation.result.data.postkkilogunscrap.PostKkilogUnScrapResult
...
interface SimpleKkilogApi {
    ...
    @POST("logs/{id}/unlkie") // 간단 끼록 좋아요 취소
